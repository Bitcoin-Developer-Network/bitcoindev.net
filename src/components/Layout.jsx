  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link
          href="https://github.com/Bitcoin-Developer-Network/bitcoindev.net"
          className="group"
          aria-label="GitHub"
        >
  ...
  let getHeadings = useCallback((tableOfContents) => {
    return tableOfContents
      ...
      .map((id, i) => {
        ...
        // tailwindui's syntax template had some bugs in it. the table of contents would sometimes not
